...
public class Form_KM extends javax.swing.JPanel {
    ...
    public void fillData(int index) {
        Model_Vourcher vc = list.get(index);
    ...
    private void initComponents() {
        ...
        btn_capnhat.setBackground(new java.awt.Color(255, 102, 102));
        btn_capnhat.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(Header, javax.swing.GroupLayout.DEFAULT_SIZE, 1013, Short.MAX_VALUE)
        );
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        Model_Vourcher vc = new Model_Vourcher(maVoucher, moTa, giamGia, giamGiaToiDa, hinhThucGiamGia, ngayBD, ngayKT, dieuKienApDung);
    ...
    private void btn_capnhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_capnhatActionPerformed
        ...
        Model_Vourcher vc = new Model_Vourcher(id, maVoucher, moTa, giamGia, giamGiaToiDa, hinhThucGiamGia, ngayBD, ngayKT, dieuKienApDung);
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        ...
        if (selectedRow != -1) {  // Kiểm tra xem có hàng nào được chọn không
            ...
            Model_Vourcher vc = new Model_Vourcher(id, true);
